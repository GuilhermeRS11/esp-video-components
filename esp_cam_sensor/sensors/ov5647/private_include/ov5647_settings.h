...
static const ov5647_reginfo_t ov5647_input_24M_MIPI_2lane_raw8_800x640_15fps[] = {
    // ---------- PLL / formato (mantém clocks do 50fps) ----------
    ...
    // (sem necessidade de setar 0x3500..0x3502/0x350A/0x350B aqui)
    ...
    // ---------- ISP/analógico (mantidos dos presets estáveis) ----------
    {0x3630, 0x2e},
    {0x3632, 0xe2},
    {0x3633, 0x23},
    {0x3634, 0x44},
    ...
    // ---------- tabelas AEC (não críticas, mas mantidas p/ compat) ----------
    {0x3a08, 0x01},
    {0x3a09, 0x27},
    {0x3a0a, 0x00},
    {0x3a0b, 0xf6},
